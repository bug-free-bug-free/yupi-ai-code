...
public class UserController {
    ...
    public BaseResponse<Page<UserVO>> listUserVOByPage(@RequestBody UserQueryRequest userQueryRequest) {
        ...
        Page<User> pageUser = userService.page(Page.of(pageNum, pageSize), queryWrapper);

        Page<UserVO> pageUserVO = Page.of(pageNum, pageSize, pageUser.getTotalRow());
        pageUserVO.setRecords(userService.getUserVOList(pageUser.getRecords()));
